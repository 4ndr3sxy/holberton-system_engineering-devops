# 0x15. API
## Details
      By Sylvain Kalache, co-founder at Holberton School          Weight: 1                Ongoing project - started 01-31-2022, must end by 02-01-2022 (in about 15 hours)          - you're done with 0% of tasks.              Checker will be released at 01-31-2022 03:36 PM              QA review fully automated.      ## Background Context
...
## Learning Objectives
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/shJvjhQJv488-f7SmzIYPw) 
...
* You must use [get](https://intranet.hbtn.io/rltoken/nVy7hbvKVJkhr5LIHIsHSg) 
...
### 0. Gather data from an API
          mandatory         Progress vs Score  Task Body Write a Python script that, using this  [REST API](https://intranet.hbtn.io/rltoken/0Ltm_dXy-m4E9jchBrKLVA) 
 , for a given employee ID, returns information about his/her TODO list progress.
Requirements:
* You must use  ` urllib `  or  ` requests `  module
* The script must accept an integer as a parameter, which is the employee ID
* The script must display on the standard output the employee TODO list progress in this exact format:* First line:  ` Employee EMPLOYEE_NAME is done with tasks(NUMBER_OF_DONE_TASKS/TOTAL_NUMBER_OF_TASKS): ` *  ` EMPLOYEE_NAME ` : name of the employee
...
### 1. Export to CSV
          mandatory         Progress vs Score  Task Body Using what you did in the task #0, extend your Python script to export data in the CSV format.
Requirements:
...
* File:  ` 1-export_to_CSV.py ` 
 Self-paced manual review  Panel footer - Controls 
### 2. Export to JSON
          mandatory         Progress vs Score  Task Body Using what you did in the task #0, extend your Python script to export data in the JSON format.
Requirements:
* Records all tasks that are owned by this employee
* Format must be: ```bash
